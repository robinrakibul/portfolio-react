      ...
      <section className='hero' id='home'>
        <div className='container f_flex'>
          <div className='left'>
            ...
            <p>
              Hi, I am Rakibul Hassan Robin,
              I am a web developer from Dhaka, Bangladesh. My expertise is in the area of react app.
              I really have a beautiful taste in technology.
              Currently I am doing web development course from programming hero to sharpening my skills and to get certified.
            </p>
